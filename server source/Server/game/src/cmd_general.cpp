...
static const char* FN_point_string(int apply_number)
{
	...
	//case POINT_MALL_ITEMBONUS:		return LC_TEXT("아이템 드롭율 %.1f배");//@turkmmo45
	//case POINT_MALL_GOLDBONUS:		return LC_TEXT("돈 드롭율 %.1f배");//@turkmmo45
	case POINT_MALL_ITEMBONUS:		return LC_TEXT("아이템 드롭율 %d배");//@turkmmo45
	case POINT_MALL_GOLDBONUS:		return LC_TEXT("돈 드롭율 %d배");//@turkmmo45
