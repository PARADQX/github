...
void initapp()
{
...
#endif
#ifdef ENABLE_CHAT
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_HEALTH_BOARD_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HEALTH_BOARD_SYSTEM", 0);
#endif
#ifdef ENABLE_VIEW_TARGET_MONSTER_HP
	PyModule_AddIntConstant(poModule, "ENABLE_VIEW_TARGET_MONSTER_HP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_VIEW_TARGET_MONSTER_HP", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EMOJI_UPDATE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EMOJI_UPDATE", 0);
#endif
